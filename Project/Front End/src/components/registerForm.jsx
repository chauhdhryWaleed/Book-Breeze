...
function SignUpForm() {
  ...
  return (
    ...
    <section className="section my-20 relative">
      ...
      <div className="container z-1 border-2 self-center mx-20 bg-emerald-100">
        <div className="py-8 px-4 my-20 border-2 z-1 s bg-white shadow-emerald-500 opacity-90  shadow-xl align-middle mx-auto max-w-2xl rounded-lg  lg:py-16">
