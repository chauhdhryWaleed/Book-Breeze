...
const ManageBooks = () => {
    ...
    const handleDelete = (id) => {
        fetch(`http://localhost:5000/book/${id}`, {
          ...
          .then((res) => res.json())
          .then((data) => {
            // Update the state to reflect changes after deletion if needed
          });
      };
        ...
        <div className='px-4 my-12'>
                ...
                {allBooks.map((book, index) => (
                    <Table.Body className="divide-y" key={book._id}>
                        <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <Table.Cell>
                                {book.price} {/* Displaying the price from book data */}
                            </Table.Cell>
                            <Table.Cell>
                                <Link
            ...
            <div className="flex items-center justify-center text-center mt-8">
                <Pagination
                    ...
                    showIcons
                    totalPages={1000} // You might need to adjust this value based on the actual total pages
                />
            </div>
        </div>
    )
