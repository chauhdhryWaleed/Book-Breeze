              ...
              <div className="flex items-stretch">
                ...
                <div className="flex flex-nowrap -space-x-3">
                  <div className="h-9 w-9">
                    <img className="object-cover w-full h-full rounded-full" src="https://ui-avatars.com/api/?background=random" alt="User" />
                  </div>
                  <div className="h-9 w-9">
                    <img className="object-cover w-full h-full rounded-full" src="https://ui-avatars.com/api/?background=random" alt="User" />
                  </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                    ...
                    <Link to="/blog" className="font-bold hover:text-yellow-800 hover:underline">Blog and social posts</Link>
